...
public class GraphicSystem extends JFrame {
	...
	private void saveCurrentState () {
	    ImageIcon icon = (ImageIcon)imgPanel.getIcon();
	    GSOperation operation = new GSOperation(icon, imageFilenames);
	...
	private void undo () {
	    if (operations.isEmpty()) {
	        ...
	        GSOperation lastState = operations.pop();
	        ImageIcon lastIcon = lastState.getImage();
	        imageFilenames = lastState.getImageQueue();
	        imgPanel.setIcon(lastIcon);
	    }
	}
